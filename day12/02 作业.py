...
# list = ['acv','sds23','ad','2121sdsad','cc']
# print([i.upper() for i in list if len(i) < 3])
...
print([l1[i]+str(i) for i in range(0,4)])
# (9)有以下数据类型：
x = {
    'name':'alex',
...
print([[value['timestamp'],value['values']]for value in x['Values']] )
